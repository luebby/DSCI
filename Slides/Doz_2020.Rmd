...
tags <- c("#causalinference", "#dataliteracy", "#FOM", "#machinelearning", "#bookofwhy", "#confounding", "#bias", "#datascience", "#potentialoutcome", "#paradox", "#directedacyclicgraphs", "#counterfactual", "#cause", "#effect", "#causaleffect", "#rstats")
...
.small[Inspiration: [De Veaux (2019). *Data Science for All*](https://iase-web.org/conference/satellite19/docs/Data%20Science%20for%20All.pdf)]
...
Unfortunately: Depending on task **not always** and quantitative measures like e.g. cross-validated mean squared error **not always** tell you which model is best.
