...
Example: sunscreen $\leftarrow$ sunshine $\rightarrow$ ice cream
  ...
  - Knowing sunscreen I learn via sunshine something about ice cream. Unconditionally, i.e. marginal, they are not independent.
  
  - Knowing sunshine I don't learn more about ice cream by sunshine. Conditionally on sunshine they are independent.
...
Example: weekend $\rightarrow$ sleep $\leftarrow$ holiday
  ...
  - Knowing that it is weekend I learn nothing about whether it is holiday: Unconditionally, i.e. marginal, they are independent.
  
  - Knowing that I can sleep late and that it is not weekend I learn that it must be holiday: Conditionally on sleep they are not independent.
