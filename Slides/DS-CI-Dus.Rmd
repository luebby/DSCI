...
- $X \rightarrow Y: \quad Y=f(X, U_Y)$ with some function $f(\cdot)$ and some exegenous $U$. 

- The value of $Y$ depends on $X$ - but the value of $X$ **not** on $Y$. 

- Causally there is no inverse function $f^{-1}(\cdot)$. My weigth growths with my height but unfortunatly my height not with my weight.
...
| Adjusting $C$             | Blocks causal path              | Blocks non-causal path         | Blocks non-causal path
